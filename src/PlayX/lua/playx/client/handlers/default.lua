...
list.Set("PlayXHandlers", "IFrame", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
	callback(playxlib.GenerateIFrame(width, height, uri))
end)

list.Set("PlayXHandlers", "JW", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    volume = adjVol -- This handler supports instant volume changing
	handlerArgs = nil
    callback(playxlib.GenerateJWPlayer(width, height, start, volume, uri))
end)

list.Set("PlayXHandlers", "JWVideo", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    volume = adjVol -- This handler supports instant volume changing
    callback(playxlib.GenerateJWPlayer(width, height, start, volume, uri, "video"))
end)

list.Set("PlayXHandlers", "JWAudio", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    volume = adjVol -- This handler supports instant volume changing
    callback(playxlib.GenerateJWPlayer(width, height, start, volume, uri, "sound"))
end)

list.Set("PlayXHandlers", "JWRTMP", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    volume = adjVol -- This handler supports instant volume changing
    callback(playxlib.GenerateJWPlayer(width, height, start, volume, uri, "rtmp"))
end)

list.Set("PlayXHandlers", "Flash", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
...
list.Set("PlayXHandlers", "Image", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    local result = playxlib.GenerateImageViewer(width, height, uri)
    result.center = true
    callback(result)
end)

list.Set("PlayXHandlers", "FlashAPI", function(width, height, start, volume, adjVol, uri, handlerArgs, callback)
    local url = uri
    local js = ""
    local result = nil
